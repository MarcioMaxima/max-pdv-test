...
-- 1. Admins and managers can see all customers in tenant
-- 2. Sellers can see customers they created OR customers linked to their orders OR the default "Consumidor" customer
